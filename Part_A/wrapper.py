import sys, random
import preprocessing_A, ngrams, emoticonlexicon, sentiwordnet
...
def wrapper(input_file, opinion_file, subjectivity_file, unigramsUse, bigramsUse, store_file):
    ...
    tweets, emoticons, hashtags, capitals, longs, sentiment = preprocessing_A.crawler(input_file)
...
unigrams, bigrams=wrapper("Data/twitter-train-cleansed-A.tsv", "Data/opinion/opinion_trainA.txt","Data/subjectivity/subjectivity_trainA.txt",unigramsUsed, bigramsUsed, "Data/train_data_A.csv")
print("# Done!\n#")

print("# Wrapping features for development dataset...")
wrapper("Data/twitter-dev-gold-A.tsv","Data/opinion/opinion_devA.txt","Data/subjectivity/subjectivity_devA.txt", unigrams, bigrams,"Data/development_data_A.csv")
print("# Done!\n#")

print("# Wrapping features for development dataset...")
wrapper("Data/twitter-test-A.tsv","Data/opinion/opinion_testA.txt","Data/subjectivity/subjectivity_testA.txt", unigrams, bigrams,"Data/test_data_A.csv")
print("# Done!\n#")
