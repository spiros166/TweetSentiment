...
subjectivity_lex(tweets_trainA,'Data/subjectivity/subjectivity_trainA.txt')
subjectivity_lex(tweets_devA,'Data/subjectivity/subjectivity_devA.txt')
subjectivity_lex(tweets_testA, 'Data/subjectivity/subjectivity_testA.txt')
